$(document).ready(function() {
	...
	function render() {
		...
		$.each(music, function(i, v) {
			...
			var div = (i === current) ? "div" : "";
//			$('<li class="' + c + '"><span>' + v.name + '</span><span class="author">' + v.author + '</span></li>').appendTo("#music-list");
//			$('<li class="' + c + '"><span>' + v.name + '</span></li>').appendTo("#music-list");
			$('<li class="' + c + '"><span>' + v.name + '</span><span class="author iconfont delete">' + v.font + '</span></li>').appendTo("#music-list");	
		});
		//歌曲歌词对应切换
		$("#content").empty();
		...
		//歌曲顶部歌名对应
		$(".song").empty();
		$('<div>'+music[current].p+'</div>').appendTo(".song");
		//
//		$('<div class="data-v">'+music[current].name+'</div>').appendTo(".song-list");
//		$('<div>'+music[current].name+'</div>').appendTo("#music-list");
	}
